...
set_property PACKAGE_PIN Y11 [get_ports {active_num[0]}]
set_property PACKAGE_PIN AA11 [get_ports {active_num[1]}]
set_property PACKAGE_PIN Y10 [get_ports {active_num[2]}]
set_property PACKAGE_PIN AA9 [get_ports {active_num[3]}]

set_property PACKAGE_PIN W12 [get_ports {active_num[4]}]
set_property PACKAGE_PIN W11 [get_ports {active_num[5]}]
set_property PACKAGE_PIN V10 [get_ports {active_num[6]}]
set_property PACKAGE_PIN W8 [get_ports select]
...
set_property PACKAGE_PIN N15 [get_ports button_in]
...
set_property IOSTANDARD LVCMOS33 [get_ports {active_num[0]}]
set_property IOSTANDARD LVCMOS33 [get_ports {active_num[1]}]
set_property IOSTANDARD LVCMOS33 [get_ports {active_num[2]}]
set_property IOSTANDARD LVCMOS33 [get_ports {active_num[3]}]

set_property IOSTANDARD LVCMOS33 [get_ports {active_num[4]}]
set_property IOSTANDARD LVCMOS33 [get_ports {active_num[5]}]
set_property IOSTANDARD LVCMOS33 [get_ports {active_num[6]}]
